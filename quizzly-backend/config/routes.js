...
module.exports.routes = {
  ...
  'post /courses/studentsection/:id': 'StudentController.getStudentSectionCourses',
  ...
  ***************************************************************************/
  ...
  /* ADMIN PORTAL */
  'post /admin/getpending': 'AdminController.getPending',
  'post /admin/makeprofessor': 'AdminController.makeOneProfessor',
  'post /admin/denyprofessor': 'AdminController.denyOneProfessor',


  /* NEW METRICS */
  'post /metrics/:id' : 'StudentAnswerController.getMetricsForQuestion',

  'post /answer-table/:section/:quiz': 'StudentAnswerController.getTableDataOfStudentAnswersForSection',

  /* USED IN EXPORT GRADES*/
  'post /question/getQuestionAnswers/': 'QuestionController.getQuestionAnswers',

  'post /question/getJsonQuestionAndUserAnswers/': 'QuestionController.getJsonQuestionAndUserAnswers',

  'post /question/getQuestionAndUserAnswer/': 'QuestionController.getQuestionAndUserAnswer',
